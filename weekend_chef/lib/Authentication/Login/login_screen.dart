...
import 'package:weekend_chef/Authentication/Login/models/sign_in_model.dart';
import 'package:weekend_chef/Authentication/Password/forgot_password.dart';
...
Future<SignInModel> signInUser(String email, String password) async {
  final response = await http.post(
    Uri.parse(hostName + "api/accounts/login-chef/"),
