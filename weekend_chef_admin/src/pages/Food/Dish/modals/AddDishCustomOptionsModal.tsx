...
const AddDishCustomOptionsModal = ({ isOpen, onClose, fetchData, dish_id }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    const dataToSend = {
      dish_id: dish_id,
      custom_option_ids: selectedOptions, // Send options as an array
    };

    const url = baseUrl + 'api/food/add-dish-custom-option-list/';
                  ...
                  customOptions.map((customOption) => (
                    ...
                    >
                      ...
                      <div className="col-span-1 flex items-center justify-end">
                        <input
                          type="checkbox"
                          id={`option-${customOption.custom_option_id}`}
                          value={customOption.custom_option_id}
                          onChange={(e) =>
                            handleOptionChange(e, customOption.custom_option_id)
                          }
                        />
                      </div>
                    </div>
...
export default AddDishCustomOptionsModal;
