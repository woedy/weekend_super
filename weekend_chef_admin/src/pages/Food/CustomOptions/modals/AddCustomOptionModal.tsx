...
const AddCustomOptionModal = ({ isOpen, onClose, fetchData }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    const url = baseUrl + 'api/orders/add-custom-option/';
    ...
    >
        ...
        >
          <div className="w-full max-w-3xl h-full flex flex-col">
            <h1 className="text-xl font-semibold mb-3">Add Custom Option</h1>
